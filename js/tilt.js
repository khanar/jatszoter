...
;(function(window) {
	...
	TiltFx.prototype.options = {
		...
		movement : {
			...
			translateZ : 5, // a relative movement of -20px to 20px on the z-axis (perspective value must be set). Also, this specific translation is done when the mouse moves vertically.
			rotateX : -20, // a relative rotation of -2deg to 2deg on the x-axis (perspective value must be set)
			rotateY : -20, // a relative rotation of -2deg to 2deg on the y-axis (perspective value must be set)
